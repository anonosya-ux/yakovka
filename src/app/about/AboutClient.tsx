...
const timeline = [
  ...
  { year: '2018', title: 'Горнолыжный спуск', desc: 'Открытие собственной горнолыжной трассы и бугельного подъемника прямо на территории отеля.' },
  { year: '2021', title: 'Расширение', desc: 'Постройка новых премиальных номеров, запуск русской бани на дровах и ресторана алтайской кухни.' },
  { year: '2024', title: 'Реновация', desc: 'Полное обновление номерного фонда, переход на стандарты сервиса премиум-класса.' }
];

const advantages = [
  { icon: Mountain, title: 'У подножия горы', desc: 'Прямой доступ к склону и подъемникам.' },
  { icon: Flame, title: 'Русская баня', desc: 'Настоящая баня на дровах с купелью и зоной отдыха.' },
  { icon: Utensils, title: 'Ресторан', desc: 'Блюда алтайской кухни из фермерских продуктов.' },
