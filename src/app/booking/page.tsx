...
const rooms = [
  ...
  },
  {
    ...
    description: 'Просторный номер с дополнительным местом (раскладное кресло-кровать), отлично подходит для небольшой семьи.',
    features: ['2 кровати + раскладное кресло', 'Wi-Fi', 'Телевизор', 'Душ'],
  },
  {
    slug: 'family',
    title: 'Семейный',
    ...
    features: ['Двуспальная кровать', 'Диван-кровать', 'Холодильник', 'Завтрак включен'],
  },
  {
    slug: 'family-plus',
    ...
    features: ['Двуспальная кровать', 'Диван-кровать', 'Телевизор', 'Зона отдыха'],
  },
  {
    slug: 'cottage',
    title: 'Коттедж',
