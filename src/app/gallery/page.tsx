...
export const metadata: Metadata = {
  ...
  description: 'Более 80 фотографий загородного отеля «Яковка» в Белокурихе: горнолыжные трассы, номера, домашняя кухня, баня, бассейн, природа Алтая. Смотрите и убедитесь сами!',
...
export default function GalleryPage() {
  const gallerySchema = {
    ...
    "description": "Более 80 фотографий: горнолыжные трассы, номера, домашняя кухня, баня, бассейн, природа Алтая",
