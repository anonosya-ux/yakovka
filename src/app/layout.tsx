...
export const metadata: Metadata = {
  ...
  description: 'Загородный отель «Яковка» у подножия горы — горнолыжный курорт в Белокурихе. Комфортные номера от 5 800 ₽, домашняя кухня, баня, 2 горнолыжные трассы. Семейный отдых на Алтае круглый год.',
