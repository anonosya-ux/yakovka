...
export const metadata: Metadata = {
  ...
  description: 'Оплата проживания в загородном отеле «Яковка»: наличные, перевод на расчетный счет, оплата по QR-коду (СБП).',
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="p-8 border border-slate-100 rounded-3xl bg-slate-50 shadow-sm flex flex-col h-full">
            ...
            <p className="text-slate-600 flex-grow">К оплате принимаются наличные и возможна оплата по QR-коду (СБП) на стойке регистрации.</p>
          </div>
          <div className="p-8 border border-slate-100 rounded-3xl bg-slate-50 shadow-sm flex flex-col h-full">
