...
export const metadata: Metadata = {
  ...
  description: 'Актуальные акции и спецпредложения загородного отеля «Яковка» в Белокурихе. Раннее бронирование, скидки на длительное проживание, семейные пакеты. Горнолыжный сезон от 3000 ₽.',
...
const offers = [
  {
    ...
    features: ['Проживание 1 ночь', 'Прокат лыж/сноуборда 4ч', 'Обед в ресторане'],
    highlight: true,
  },
  {
    icon: CalendarDays,
