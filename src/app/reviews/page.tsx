...
const reviews = [
  ...
  },
  {
    ...
    date: 'Январь 2026',
    rating: 4,
    text: 'Отдыхали на новогодние праздники. Очень красиво, природа потрясающая. Номер «Коттедж» просто огромный — разместились всей семьёй с двумя детьми. Домашняя кухня порадовал алтайской кухней. Единственное — в праздники очень много людей.',
  },
  {
    name: 'Дмитрий Волков',
    date: 'Декабрь 2025',
