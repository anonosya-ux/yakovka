...
const reviews = [
  ...
  },
  {
    ...
    date: 'Январь 2026',
    rating: 4,
    text: 'Отдыхали на новогодние праздники. Очень красиво, природа потрясающая. Номер «Семейный++» просто огромный — разместились всей семьёй с двумя детьми. Домашняя кухня порадовал алтайской кухней. Единственное — в праздники очень много людей.',
  },
  {
    name: 'Дмитрий Волков',
    date: 'Декабрь 2025',
  ...
  },
  {
    ...
    date: 'Июнь 2025',
    rating: 5,
    text: 'Идеальное место для романтического отдыха! Тихо, красиво, уютно. Ужин в домашняя кухняе с видом на горы — незабываемо. Персонал очень внимательный. Муж заказал торт на годовщину — ребята сделали всё идеально.',
  },
  {
    name: 'Алексей Крылов',
    date: 'Март 2025',
