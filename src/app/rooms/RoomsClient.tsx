...
const rooms = [
  ...
  },
  {
    ...
    description: 'Просторный однокомнатный номер с дополнительным местом (кресло-кровать), отлично подходящий для небольшой семьи или компании. При бронировании через сайт завтрак включён в стоимость проживания.',
    features: ['Двуспальная кровать', 'Кресло-кровать', 'Wi-Fi', 'Телевизор', 'Душ', 'Чайник'],
  },
  {
    slug: 'family',
    ...
    features: ['Двуспальная кровать', 'Кресло-кровать', 'Холодильник', 'Завтрак включен', 'Чайная станция', 'Душ и санузел'],
  },
  {
    slug: 'family-plus',
    ...
    features: ['Двуспальная кровать', 'Кресло-кровать', 'Телевизор', 'Завтрак включен', 'Холодильник', 'Зона отдыха'],
  },
  {
    slug: 'cottage',
    title: 'Коттедж',
              ...
              <div key={room.slug} className="anim-room flex flex-col md:flex-row bg-white rounded-[2.5rem] overflow-hidden shadow-sm border border-stone-100 hover:shadow-premium transition-all duration-500">
                ...
                <div className="p-8 md:p-12 flex flex-col flex-grow w-full md:w-7/12">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Link 
                      href="/booking"
                      className="flex-1 inline-flex items-center justify-center px-8 py-5 rounded-2xl text-lg font-bold bg-primary text-white hover:bg-stone-900 transition-colors shadow-lg shadow-primary/20"
                    >
                      Забронировать
                    </Link>
