...
const roomsData: Record<string, any> = {
  ...
  'family': {
    title: 'Семейный',
    description: 'Семейный номер с двуспальной кроватью. Создан для комфортного проживания пар или семей с ребенком.',
    size: '20 м²',
  ...
  'family-plus': {
    title: 'Семейный +',
    description: 'Просторный номер улучшенной планировки. Больше пространства для комфортного размещения вашей семьи.',
    size: '25 м²',
    guests: 'До 5 человек',
    price: 'от 7 500 ₽',
    img: '/optimized/Номера/Семейный+/Семейный+-01.webp',
    features: ['1 двуспальная кровать', 'Большой диван', 'Комната отдыха', 'Санузел, душ в номере', 'Завтрак включен']
  },
  'cottage': {
    title: 'Коттедж (Семейный ++)',
    description: 'Отдельный коттедж для максимального уединения. Просторная терраса, своя мангальная зона и премиальная отделка.',
    size: '60 м²',
    guests: 'До 8 человек',
    price: '10 000 ₽',
    img: '/optimized/Номера/Семейный++/Семейный++-01.webp',
