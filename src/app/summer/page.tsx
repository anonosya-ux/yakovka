...
import { Sun, TreePine, Waves, Camera, Bike, UtensilsCrossed } from 'lucide-react';
...
const activities = [
  {
    icon: TreePine,
    title: 'Горные походы',
    desc: 'Пешие маршруты по живописным тропам Алтая — от простых прогулок до многочасовых треков. Гид — по договорённости.',
  },
  {
    icon: Camera,
    title: 'Экскурсия на Церковку',
    desc: 'Подъём на канатной дороге на гору Церковка (815 м) с панорамным видом на Белокуриху и Чергинский хребет.',
  },
  {
    icon: Waves,
    title: 'Речной отдых',
    desc: 'Купание в горных реках, рыбалка в чистых алтайских водоёмах. Идеально для жарких летних дней.',
  },
  {
    icon: Bike,
    title: 'Велопрогулки',
    desc: 'Аренда велосипедов и маршруты по терренкурам Белокурихи. Подходит для семей с детьми.',
  },
  {
    icon: UtensilsCrossed,
    title: 'Шашлык на природе',
    desc: 'Мангальные зоны на территории отеля. Всё необходимое для барбекю предоставляется.',
  },
  {
    icon: Sun,
    title: 'Загорание и отдых',
    desc: 'Шезлонги на зелёной территории отеля, детская площадка, батуты. Полный релакс на свежем воздухе.',
  },
];
...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'Конечно! На территории отеля есть детская площадка и батут. Поблизости — аквапарк, конные прогулки, верёвочный парк. Детское меню в ресторане.',
  },
];
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-stone-100">
                ...
                <p className="text-stone-500 leading-relaxed">Летние цены на проживание от 3 000 ₽/сутки. Специальные пакеты «Летний релакс» со скидкой 20% при бронировании от 5 ночей.</p>
              </div>
            </div>
          </div>
        </div>
