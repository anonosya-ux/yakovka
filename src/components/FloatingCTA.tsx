...
export default function FloatingCTA() {
  ...
  return (
    <>
      {/* Desktop floating CTA — unchanged */}
      ...
      <div className="fixed bottom-6 right-4 z-40 md:hidden flex flex-col-reverse items-end gap-3">
        {/* Main toggle button */}
        <button
          ...
          className={`w-14 h-14 rounded-full flex items-center justify-center shadow-premium-lg transition-all duration-300 ${
            isExpanded
              ...
              : 'bg-primary text-white animate-float-bounce'
          }`}
        ...
        >
          ...
          >
            ...
            <div className="w-12 h-12 bg-primary text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform">
          ...
          >
            ...
            <div className="w-12 h-12 bg-[#2AABEE] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform">
          ...
          >
            ...
            <div className="w-12 h-12 bg-stone-800 text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform">
